...
const sections = [
  {
    ...
    description:
      "A unified detection layer for your global operations. R3FLEX watches shipments, signals, and supply chains across 190+ countries — so your team can act on what matters, in the moment it happens.",
    align: "left" as const,
    actions: [
